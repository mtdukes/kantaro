...
ap.add_argument("--bucketname", help="name of the bucket to use in s3")
args = ap.parse_args()
...
def get_campaign_totals(filename):
    ...
    if args.bucketname:
        s3.Object(args.bucketname, 'data/campaign_totals.csv').put(Body=open(data_dest+'campaign_totals.csv', 'rb'))
...
def get_sponsor_totals(filename):
    ...
    if args.bucketname:
        s3.Object(args.bucketname, 'data/sponsor_totals.csv').put(Body=open(data_dest+'sponsor_totals.csv', 'rb'))
...
def get_historical_totals(filename):
    ...
    if args.bucketname:
        s3.Object(args.bucketname, 'data/historical_totals.csv').put(Body=open(data_dest+'historical_totals.csv', 'rb'))
